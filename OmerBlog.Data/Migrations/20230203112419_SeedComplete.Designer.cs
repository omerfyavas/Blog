...
namespace OmerBlog.Data.Migrations
{
    ...
    [Migration("20230203112419_SeedComplete")]
            ...
            modelBuilder.Entity("OmerBlog.Entity.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3c144f66-c1a2-41b9-a92a-3cb7b6a6a7b5"),
                            ...
                            CreatedBy = "Admin",
                            CreatedOn = new DateTime(2023, 2, 3, 14, 24, 18, 981, DateTimeKind.Local).AddTicks(7218),
                        ...
                        new
                        {
                            Id = new Guid("57050432-f805-4376-9fef-33c5798418f2"),
                            ...
                            CreatedBy = "Admin",
                            CreatedOn = new DateTime(2023, 2, 3, 14, 24, 18, 981, DateTimeKind.Local).AddTicks(7227),
            ...
            modelBuilder.Entity("OmerBlog.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d7d90594-8994-489c-93b7-66c06969ba52"),
                            CreatedBy = "Admin",
                            CreatedOn = new DateTime(2023, 2, 3, 14, 24, 18, 981, DateTimeKind.Local).AddTicks(7541),
                            IsDeleted = false,
                            Name = "Deneme Makale"
                        },
                        new
                        {
                            ...
                            CreatedBy = "Admin",
                            CreatedOn = new DateTime(2023, 2, 3, 14, 24, 18, 981, DateTimeKind.Local).AddTicks(7549),
                            IsDeleted = false,
                            Name = "Deneme Makale"
                        });
                });
            ...
            modelBuilder.Entity("OmerBlog.Entity.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin",
                            CreatedOn = new DateTime(2023, 2, 3, 14, 24, 18, 981, DateTimeKind.Local).AddTicks(7857),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Admin",
                            CreatedOn = new DateTime(2023, 2, 3, 14, 24, 18, 981, DateTimeKind.Local).AddTicks(7863),
                            FileName = "image/testimage",
                            FileType = "png",
                            IsDeleted = false
                        });
